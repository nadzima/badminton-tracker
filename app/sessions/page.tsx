  ...
  return (
    <div className="space-y-5">
      ...
      <div className="flex items-center justify-between">
        ...
        <Link
          href="/sessions/new"
          className="bg-primary-600 text-white text-sm font-bold px-4 py-2 rounded-full hover:bg-primary-700 transition-colors"
        >
          ➕ Baru
        </Link>
      </div>
              ...
              <div className="bg-white rounded-2xl px-5 py-4 shadow-sm border border-slate-100 hover:border-primary-300 transition-all">
                <div className="flex items-start justify-between">
                  <div>
                    ...
                    {s.location && (
                      <p className="text-sm text-slate-500 mt-0.5">📍 {s.location}</p>
                    )}
                    {s.notes && (
                      <p className="text-sm text-slate-400 mt-1 line-clamp-1">{s.notes}</p>
                    )}
                  </div>
                  <span
